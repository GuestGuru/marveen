...
- 🔴 **A `chat_id: 0` NEM megy Telegramon.** 2026-08-12-en a `chat_id: "0"`-ra kuldott
  ...
  DM-azonosito a **scheduler-fejlecben** all -- azzal ment el elsore.
...
- **A csatorna nem feltétlenül Telegram.** A task szövege Telegramra (chat_id 0, illetve a scheduler-fejlécben álló valódi azonosító)
