...
export function buildMemoryRulesBody(): string {
  return [
    ...
    '   frissíti a találatok `accessed_at` mezőjét. Tehát KERESÉS UTÁN a listázás',
    '   sorrendje megváltozhat, és a plafon másokat vág le. Puszta ismételt listázásnál nem.)',
    ...
    '   más ír egy sharedet. **Tehát a szabály NEM az, hogy „az API csonkíthat" -- hanem',
    '   hogy a teljesség-állításhoz a DB kell, akkor is, ha neked eddig mindig teljeset adott.**',
    '',
