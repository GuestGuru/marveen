...
export function buildMemoryRulesBody(): string {
  return [
    ...
    '   csak nem forgatható és nem visszavonható. Aznap 63 UUID-alakú azonosító állt a',
    '   flotta emlékeiben. **A próba nem az, hogy honnan való az azonosító, hanem hogy',
    ...
    '   négy találatból kettőt kihagyott, mindkettő valódi lakás-azonosító volt. A',
    ...
    '   ⚠️ **És a mérés a DB-ből menjen, ne a listázó API-ból:** a `GET /api/memories`',
    '   200 sornál levág. 2026-09-09-én egy ágens 105 bejegyzéséből 67 jött vissza, és',
    '   a válasz teljesnek látszott. A válasz azóta `X-Memories-Truncated` fejlécet ad,',
    '   de egy teljes körű audit így is közvetlen DB-olvasás. **A `limit` nélküli hívás',
    '   50-nél áll meg**, és a kategória-szűrés sem old meg mindent: ugyanaznap egy',
    '   `category=shared` listázás pontosan 50 sort adott. **Több lekérdezés UNIÓJA sem',
    '   bizonyíték**, csak jobb becslés: peppa így 64 helyett 69 saját bejegyzést talált,',
    '   és a különbségben ott volt egy UUID-t tartalmazó sor is.',
