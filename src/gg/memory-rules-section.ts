...
export function buildMemoryRulesBody(): string {
  return [
    ...
    'meg", „azután majd" -- de az igeidő ÖNMAGÁBAN sok hamis pozitívot ad (mérve: 7-ből 6),',
    'mert a tudás-emlékek tele vannak jogos jövő idővel. Párosítsd FELSOROLÁS-JELÖLÉSSEL:',
    'a valódi találat egy számozott vagy felsorolt tételre mutat („(a)", „NYITOTT:"), tehát',
    'a szerző maga jelölte meg listaelemként. Ezt vedd ki külön `hot` bejegyzésbe, a tudás-részt hagyd a',
