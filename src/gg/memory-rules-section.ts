...
export function buildMemoryRulesBody(): string {
  return [
    ...
    '',
    '**Javításkor záradékolj, ne törölj** -- de a `hot` tier kivétel: ott a TUDÁST',
    'záradékold és a MUNKAÁLLAPOTOT töröld, különben nem lesz ránézésre látható, mi az',
    'aktív. A záradékban elöl álljon a HELYES állítás és alatta a meghaladott, mert a',
