...
export function buildSendReliabilityBody(identity: SendReliabilityIdentity): string {
  ...
  return [
    ...
    'idézőjel-csapda.',
    '',
    '⚠️ **A saját fájljaidban álló curl-példa KÉT mért hibaosztálynak van kitéve, nem csak',
    'egynek.** Ez nem stílus-kérdés. Az a példa a tartalmat DUPLA IDÉZŐJELES shell-argumentumba',
    'teszi, tehát (a) nincs benne verify+retry, és (b) egy idézőjel a szövegben félbevágja az',
    'üzenetet, miközben a küldés `OK id=<n>`-t ír. A (b)-t 2026-09-10-én mértük ki egy éles',
    'üzeneten: a szöveg ott szakadt meg, ahol egy záró idézőjel következett volna, és a tárolt',
    'tartalomban nulla idézőjel volt. A kiváltó ok az IDÉZŐJEL, nem a zárójel: a zárójel csak',
    'azért szerepelt a hibaüzenetben, mert az idézőjel után már idézetlen shell-szövegben állt.',
    'Ezért a „kerüld a zárójelet" NEM véd meg, a STDIN idézett heredoc igen.',
    '',
    '**ÉS AMI MÉRVE NEM RONTJA EL:** ugyanaz a küldő, ugyanaz a tartalom, STDIN-en, idézett',
    'heredoc-kal: 3326 karakter, TÍZ idézőjellel, hibátlanul átment. A két üzenet párban áll,',
    'és ezért többet mond, mint a hiba önmagában: az argv-út az első idézőjelnél elvágta, a',
    'heredoc-os út tíz idézőjelet is elvitt. A doksiba nem elég beírni, mi rontja el; az kell',
    'mellé, ami mérve NEM rontja el.',
    '',
    '**A LEGOLCSÓBB DIAGNOSZTIKA, ha egy üzenet félbevágva érkezett: nézd meg a TÁROLT hosszt.**',
    'Ha a DB-ben tárolt sor IS csonka, a hiba a küldés ELŐTT történt (shell-idézőjelezés, a',
    'tartalom a scriptig el sem jutott). Ha a tárolt sor teljes, de a címzettnél csonka, akkor',
    'kézbesítési. A tünet ugyanaz, a réteg nem, és rossz rétegben keresni drága.',
    '',
    'A kézbesítési ágról amit MÉRTÜNK (2026-09-10, négy fokozat 2000 és 20000 karakter között,',
    'sorszámozott blokkokkal, és a CÍMZETT mérte vissza): nincs csonkulás, sem a végén, sem a',
    'közepén. Amit NEM mértünk: kódolási hibák, párhuzamos beszúrás, 20000 feletti méret, és a',
    'kézbesítési ág EGYETLEN fogadón lett mérve. Más panel-beállítás vagy terminál-méret',
    'elvileg mást adhat; nem hisszük, hogy adna, de nem mértük. Ezért',
    'ne általánosíts „a csatorna 20 ezerig biztonságos"-ra: az a következő embert rossz helyre',
    'küldi.',
    '',
    'Ha mégis nyers curl-t használsz, a szabály ugyanaz, csak neked kell megcsinálnod:',
    '```bash',
